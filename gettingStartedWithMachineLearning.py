...
""" sgd ('stochastic graident of descent') is the optimizer for this network 
    [https://www.geeksforgeeks.org/ml-stochastic-gradient-descent-sgd/]
    loss is the function used to calculate the accuracy of the predictions to the truth values
    in this case mean_squared_error
"""
